...
`page_load_failed`, `browser_crashed`, `selector_not_found`, `moderation_blocked`, `upload_failed`, `download_failed`, `download_timeout`, and `generation_timeout`. This lets automation resume, back off, switch providers,
