...
`moderation_blocked`, `download_failed`, and `generation_timeout`. This lets automation resume, back off, switch providers,
...
CAPTCHA, login-required sessions, network or download errors, rate limits, and concurrency limits from all
